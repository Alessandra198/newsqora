...
(function () {
  ...
  var PRIVACY = [
    ...
    { h: 'Contact', body: '<p style="margin:0">Data-protection requests and general enquiries: <a href="mailto:newsqora@gmail.com" style="color:var(--accent)">newsqora@gmail.com</a>.</p>' }
  ];
