...
(function () {
  ...
  // ---- Constants & content ----------------------------------------------
  var EMAIL = ['hello', 'newsqora.com'].join('@'); // joined to dodge scanners
  ...
  var PRIVACY = [
    ...
    { h: 'Changes and effective date', body: '<p style="margin:0">We may update this policy as the service evolves or as legal review concludes. Material changes will be posted here with a revised effective date. <strong style="color:var(--ink)">Effective date: 24 June 2026.</strong></p>' },
    { h: 'Contact', body: '<p style="margin:0">Data-protection requests and general enquiries: <a href="mailto:hello@newsqora.com" style="color:var(--accent)">hello@newsqora.com</a>.</p>' }
  ];
  ...
  var TERMS = [
    ...
    { h: '3 · Beta service', body: '<p style="margin:0">Newsqora is currently offered as a <strong style="color:var(--ink)">beta</strong>. Features may change, be added, or be removed, and the service may be suspended or discontinued at any time without notice. We do not guarantee continuous availability during the beta.</p>' },
    { h: '4 · Not professional advice', body: '<p style="margin:0">Newsqora does not provide medical, legal, financial, or other professional advice, and its output must not be relied upon as such. For decisions in those areas, consult a qualified professional. You are responsible for how you act on the information provided.</p>' },
    { h: '5 · Acceptable use', body: '<p style="margin:0 0 12px">You agree to use Newsqora lawfully and for genuine verification. You agree not to:</p><ul style="margin:0; padding-left:20px; display:flex; flex-direction:column; gap:7px"><li>use the service for any illegal activity, or to facilitate one;</li><li>seek or generate dark-web, harmful, exploitative, or otherwise dangerous content;</li><li>attempt to harass, defame, or endanger any person using the service;</li><li>interfere with, overload, or attempt to reverse-engineer the service or its security.</li></ul>' },
    { h: '6 · Accounts and sign-in', body: '<p style="margin:0">During the beta, using Newsqora <strong style="color:var(--ink)">requires signing in with Google</strong>; there is no guest mode. You are responsible for activity under your account and for keeping your sign-in secure. You are responsible for your compliance with these terms, and we may restrict or block access that violates them or threatens the security of the service.</p>' },
    { h: '7 · Minimum age', body: '<p style="margin:0">Newsqora is intended for users who meet the <strong style="color:var(--ink)">minimum age required in their country</strong> to consent to the processing of their personal data. By using Newsqora you confirm you meet that age. See the <a href="/privacy" data-link="privacy" style="color:var(--accent)">Privacy Policy</a> for details.</p>' },
    { h: '8 · Sources and accuracy', body: '<p style="margin:0">Newsqora reports what verifiable sources say and grades its confidence accordingly; it does not claim certainty and will state when sources are insufficient. Source material is owned by its respective publishers, and links are provided for reference only. We do not endorse the content of third-party sources.</p>' },
    { h: '9 · Intellectual property', body: '<p style="margin:0">Newsqora, including its name, logo, design, text, and software, is owned by the operator and protected by applicable law. These terms grant you no ownership or licence beyond the right to use the service as intended. Source material accessed through Newsqora remains owned by its respective publishers.</p>' },
    { h: '10 · No warranty', body: '<p style="margin:0">The service is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo;, without warranties of any kind, express or implied, including accuracy, fitness for a particular purpose, or uninterrupted availability, to the fullest extent permitted by law.</p>' },
    { h: '11 · Limitation of liability', body: '<p style="margin:0">To the fullest extent permitted by law, the operator of Newsqora is not liable for any indirect, incidental, or consequential damages arising from your use of, or reliance on, the service or its output.</p>' },
    { h: '12 · Governing law and jurisdiction', body: '<p style="margin:0">These terms are governed by the laws of <strong style="color:var(--ink)">Spain</strong>. Any dispute arising from them or from your use of Newsqora will be subject to the competent courts of Spain, without prejudice to any mandatory consumer-protection rights available to you in your country of residence.</p>' },
    { h: '13 · Changes and contact', body: '<p style="margin:0">We may update these terms as the service evolves; material changes will be posted here with an updated date. Questions about these terms: <a href="mailto:hello@newsqora.com" style="color:var(--accent)">hello@newsqora.com</a>.</p>' }
  ];
  ...
  function footer() {
    return '<footer style="background:var(--card); border-top:1px solid var(--hairline);">' +
      ...
      '<div style="max-width:1140px; margin:0 auto; padding:18px clamp(20px,5vw,40px) 40px; border-top:1px solid var(--hairline); display:flex; flex-wrap:wrap; gap:10px 20px; justify-content:space-between; align-items:center;">' +
        '<p style="font-family:\'IBM Plex Mono\',monospace; font-size:11.5px; color:var(--ink-mute); margin:0;">© 2026 Alessandra Rinaldo. All rights reserved.</p>' +
