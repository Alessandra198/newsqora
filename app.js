...
(function () {
  ...
  var PRIVACY = [
    ...
    { h: 'Changes and effective date', body: '<p style="margin:0">We may update this policy as the service evolves or as legal review concludes. Material changes will be posted here with a revised effective date. <strong style="color:var(--ink)">Effective date: 24 June 2026 (draft).</strong></p>' },
